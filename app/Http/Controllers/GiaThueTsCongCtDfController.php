...
class GiaThueTsCongCtDfController extends Controller
{
    public function store(Request $request){
        ...
        if(isset($inputs['tents'])){
            ...
            $modeladd = new GiaThueTsCongCtDf();
            $modeladd->create($inputs);

            $model = GiaThueTsCongCtDf::where('maxa',$inputs['maxa'])
                ->get();
    ...
    public function show(Request $request)
    {
        ...
        if(isset($inputs['id'])){
            ...
            $model = GiaThueTsCongCtDf::where('id',$inputs['id'])
                ->first();
            //dd($model);
    ...
    public function update(Request $request){
        ...
        if(isset($inputs['id'])){
            $modelupdate = GiaThueTsCongCtDf::where('id',$inputs['id'])->first();
            $inputs['soluong'] = getMoneyToDb($inputs['soluong']);
            $inputs['dongiathue'] = getMoneyToDb($inputs['dongiathue']);
            $inputs['sotienthuenam'] = getMoneyToDb($inputs['sotienthuenam']);
    ...
    public function destroy(Request $request){
        ...
        if(isset($inputs['id'])){
            $modelts = GiaThueTsCongCtDf::where('id',$inputs['id'])->delete();
