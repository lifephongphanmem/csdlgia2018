    ...
    public function edit(Request $request){
        ...
        if(isset($inputs['id'])){
            ...
            $result['message'] .= '<div><select  name="loaixeedit" id="loaixeedit" class="form-control">
                                <option value="Xe 4 chỗ"'.(($model->loaxe == "Xe 4 chỗ") ? "selected" : "").'>Xe 4 chỗ</option>
                                <option value="Xe 5 chỗ"'.(($model->loaxe == "Xe 5 chỗ") ? "selected" : "").'>Xe 5 chỗ</option>
                                <option value="Xe 7 chỗ"'.(($model->loaxe == "Xe 7 chỗ") ? "selected" : "").'>Xe 7 chỗ</option>
                                <option value="Xe 16 chỗ'.(($model->loaxe == "Xe 16 chỗ") ? "selected" : "").'">Xe 16 chỗ</option>
                                <option value="Xe 29 chỗ"'.(($model->loaxe == "Xe 29 chỗ") ? "selected" : "").'>Xe 29 chỗ</option>
                                <option value="Xe 35 chỗ"'.(($model->loaxe == "Xe 35 chỗ") ? "selected" : "").'>Xe 35 chỗ</option>
                                <option value="Xe 45 chỗ"'.(($model->loaxe == "Xe 45 chỗ") ? "selected" : "").'>Xe 45 chỗ</option>
                                <option value="Xe 47 chỗ"'.(($model->loaxe == "Xe 47 chỗ") ? "selected" : "").'>Xe 47 chỗ</option>
                                <option value="Loại xe khác"'.(($model->loaxe == "Loại xe khác") ? "selected" : "").'>Loại xe khác</option>
                                    </select></div>';
            $result['message'] .= '</div>';
            $result['message'] .= '</div>';
            $result['message'] .= '<div class="col-md-6">';
