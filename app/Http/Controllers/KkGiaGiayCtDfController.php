...
class KkGiaGiayCtDfController extends Controller
{
    public function store(Request $request){
        ...
        if(isset($inputs['tthhdv'])){
            $modelkkgia = new KkGiaGiayCtDf();
            $modelkkgia->create($inputs);
            $model = KkGiaGiayCtDf::where('maxa',$inputs['maxa'])
                ->get();
    ...
    public function edit(Request $request){
        ...
        if(isset($inputs['id'])){
            $id = $inputs['id'];
            $model = KkGiaGiayCtDf::findOrFail($id);
    ...
    public function update(Request $request){
        ...
        $inputs['dongia'] = getMoneyToDb($inputs['dongia']);
        if(isset($inputs['id'])){
            $modelkkgia = KkGiaGiayCtDf::where('id',$inputs['id'])->first();
