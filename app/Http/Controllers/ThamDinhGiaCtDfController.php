...
class ThamDinhGiaCtDfController extends Controller
{
    public function store(Request $request){
        ...
        if(isset($inputs['tents']) &&  $inputs['tents']!=''){
            ...
            $modelts = new ThamDinhGiaCtDf();
            $modelts->create($inputs);

            $model = ThamDinhGiaCtDf::where('maxa',$inputs['maxa'])
                ->get();
    ...
    public function update(Request $request){
        ...
        if(isset($inputs['id'])){
            $modelupdate = ThamDinhGiaCtDf::where('id',$inputs['id'])->first();
            $inputs['sl'] = getDbl($inputs['sl']);
            $inputs['nguyengiadenghi'] = getDbl($inputs['nguyengiadenghi']);
            $inputs['giadenghi'] = getDbl( $inputs['giadenghi']);
            $inputs['nguyengiathamdinh']= getDbl($inputs['nguyengiathamdinh']);
            ...
            $model = ThamDinhGiaCtDf::where('maxa',$inputs['maxa'])->get();
    ...
    public function destroy(Request $request){
        ...
        if(isset($inputs['id'])){
            $modelts = ThamDinhGiaCtDf::where('id',$inputs['id'])->delete();
