...
class GiaThueDatNuocCtDfController extends Controller
{
    public function store(Request $request){
        ...
        if(isset($inputs['vitri'])){
            ...
            $modeladd = new GiaThueDatNuocCtDf();
            $modeladd->create($inputs);

            $model = GiaThueDatNuocCtDf::where('district',$inputs['district'])
                ->get();
    ...
    public function edit(Request $request)
    {
        ...
        if(isset($inputs['id'])){
            ...
            $model = GiaThueDatNuocCtDf::where('id',$inputs['id'])
                ->first();
            //dd($model);
    ...
    public function update(Request $request){
        ...
        if(isset($inputs['id'])){
            $modelupdate = GiaThueDatNuocCtDf::where('id',$inputs['id'])->first();
            $inputs['dientich'] = getMoneyToDb($inputs['dientich']);
            $inputs['dongia'] = getMoneyToDb($inputs['dongia']);
    ...
    public function destroy(Request $request){
        ...
        if(isset($inputs['id'])){
            $modelts = GiaThueDatNuocCtDf::where('id',$inputs['id'])->delete();
