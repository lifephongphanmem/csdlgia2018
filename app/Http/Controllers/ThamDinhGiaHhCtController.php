...
class ThamDinhGiaHhCtController extends Controller
{
    public function edit(Request $request){
        ...
        if(isset($inputs['id'])){
            ...
            $model = ThamDinhGiaHhCt::where('id',$inputs['id'])
                ->first();
            //dd($model);
    ...
    public function update(Request $request){
        ...
        if(isset($inputs['id'])){
            $modelupdate = ThamDinhGiaHhCt::where('id',$inputs['id'])->first();
            ...
            $model = ThamDinhGiaHhCt::where('mahs',$inputs['mahs'])
                ->get();
