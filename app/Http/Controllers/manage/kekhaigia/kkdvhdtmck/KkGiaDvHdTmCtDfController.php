...
class KkGiaDvHdTmCtDfController extends Controller
{
    public function store(Request $request){
        ...
        if(isset($inputs['ten'])){
            $modelkkgia = new KkGiaDvHdTmCtDf();
            $modelkkgia->create($inputs);
            $model = KkGiaDvHdTmCtDf::where('maxa',$inputs['maxa'])
                ->get();
    ...
    public function edit(Request $request){
        ...
        if(isset($inputs['id'])){
            $id = $inputs['id'];
            $model = KkGiaDvHdTmCtDf::findOrFail($id);
            //dd($model);
    ...
    public function update(Request $request){
        ...
        $inputs['gia'] = getMoneyToDb($inputs['gia']);
        if(isset($inputs['ten'])){
            $modelkkgia = KkGiaDvHdTmCtDf::where('id',$inputs['id'])->first();
