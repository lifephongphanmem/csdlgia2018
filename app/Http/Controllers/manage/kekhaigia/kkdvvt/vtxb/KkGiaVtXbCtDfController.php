...
class KkGiaVtXbCtDfController extends Controller
{
    public function store(Request $request){
        ...
        if(isset($inputs['tthhdv'])){
            $modelkkgia = new KkGiaVtXbCtDf();
            $modelkkgia->create($inputs);
            $model = KkGiaVtXbCtDf::where('maxa',$inputs['maxa'])
                ->get();
    ...
    public function edit(Request $request){
        ...
        if(isset($inputs['id'])){
            $id = $inputs['id'];
            $model = KkGiaVtXbCtDf::findOrFail($id);
    ...
    public function update(Request $request){
        ...
        $inputs['dongia'] = getMoneyToDb($inputs['dongia']);
        if(isset($inputs['id'])){
            $modelkkgia = KkGiaVtXbCtDf::where('id',$inputs['id'])->first();
