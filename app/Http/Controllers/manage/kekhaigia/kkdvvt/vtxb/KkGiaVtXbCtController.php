...
class KkGiaVtXbCtController extends Controller
{
    public function store(Request $request){
        ...
        if(isset($inputs['tthhdv'])){
            $modelkkgia = new KkGiaVtXbCt();
            $modelkkgia->create($inputs);
            $model = KkGiaVtXbCt::where('mahs',$inputs['mahs'])
                ->get();
    ...
    public function edit(Request $request){
        ...
        if(isset($inputs['id'])){
            $id = $inputs['id'];
            $model = KkGiaVtXbCt::findOrFail($id);
    ...
    public function update(Request $request){
        ...
        $inputs['dongia'] = getMoneyToDb($inputs['dongia']);
        if(isset($inputs['id'])){
            $modelkkgia = KkGiaVtXbCt::where('id',$inputs['id'])->first();
