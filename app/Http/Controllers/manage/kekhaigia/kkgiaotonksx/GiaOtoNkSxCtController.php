...
class GiaOtoNkSxCtController extends Controller
{
    public function store(Request $request){
        ...
        if(isset($inputs['tthhdv'])){
            $modelkkgia = new GiaOtoNkSxCt();
            $modelkkgia->create($inputs);
            $model = GiaOtoNkSxCt::where('mahs',$inputs['mahs'])
                ->get();
    ...
    public function edit(Request $request){
        ...
        if(isset($inputs['id'])){
            $id = $inputs['id'];
            $model = GiaOtoNkSxCt::findOrFail($id);
    ...
    public function update(Request $request){
        ...
        $inputs['dongia'] = getMoneyToDb($inputs['dongia']);
        if(isset($inputs['id'])){
            $modelkkgia = GiaOtoNkSxCt::where('id',$inputs['id'])->first();
