...
class GiaXeMayNkSxCtController extends Controller
{
    public function store(Request $request){
        ...
        if(isset($inputs['tthhdv'])){
            $modelkkgia = new GiaXeMayNkSxCt();
            $modelkkgia->create($inputs);
            $model = GiaXeMayNkSxCt::where('mahs',$inputs['mahs'])
                ->get();
    ...
    public function edit(Request $request){
        ...
        if(isset($inputs['id'])){
            $id = $inputs['id'];
            $model = GiaXeMayNkSxCt::findOrFail($id);
    ...
    public function update(Request $request){
        ...
        $inputs['dongia'] = getMoneyToDb($inputs['dongia']);
        if(isset($inputs['id'])){
            $modelkkgia = GiaXeMayNkSxCt::where('id',$inputs['id'])->first();
