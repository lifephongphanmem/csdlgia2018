...
class KkGiaTaCnCtDfController extends Controller
{
    public function store(Request $request){
        ...
        if(isset($inputs['tenhh'])){
            $modelkkgia = new KkGiaTaCnCtDf();
            $modelkkgia->create($inputs);
            $model = KkGiaTaCnCtDf::where('maxa',$inputs['maxa'])
                ->get();
    ...
    public function edit(Request $request){
        ...
        if(isset($inputs['id'])){
            $id = $inputs['id'];
            $model = KkGiaTaCnCtDf::findOrFail($id);
            //dd($model);
    ...
    public function update(Request $request){
        ...
        $inputs = $request->all();
        if(isset($inputs['id'])){
            $modelkkgia = KkGiaTaCnCtDf::where('id',$inputs['id'])->first();
    ...
    public function kkgialk(Request $request){
        ...
        $inputs = $request->all();
        if(isset($inputs['id'])){
            $model = KkGiaTaCnCtDf::where('id',$inputs['id'])
                ->first();
