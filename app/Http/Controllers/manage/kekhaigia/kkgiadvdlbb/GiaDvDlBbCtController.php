...
class GiaDvDlBbCtController extends Controller
{
    public function store(Request $request){
        ...
        if(isset($inputs['tthhdv'])){
            $modelkkgia = new GiaDvDlBbCt();
            $modelkkgia->create($inputs);
            $model = GiaDvDlBbCt::where('mahs',$inputs['mahs'])
                ->get();
    ...
    public function edit(Request $request){
        ...
        if(isset($inputs['id'])){
            $id = $inputs['id'];
            $model = GiaDvDlBbCt::findOrFail($id);
    ...
    public function update(Request $request){
        ...
        $inputs['dongia'] = getMoneyToDb($inputs['dongia']);
        if(isset($inputs['id'])){
            $modelkkgia = GiaDvDlBbCt::where('id',$inputs['id'])->first();
