        ...
        if (Session::has('admin')) {
            if (session('admin')->level == 'T' || session('admin')->level == 'H' || session('admin')->level == 'X') {
                ...
                return view('manage.kkgia.dkg.kekhaimhbog.kekhai.ttdn')
                    ...
                    ->with('ttql',$ttql)
                    ->with('inputs',$inputs)
                    ->with('pageTitle', 'Danh sách thông tin doanh nghiệp kê khai giá');
            } else {
                return view('errors.perm');
            }
        }else
    ...
    public function index(Request $request){
        if (Session::has('admin')) {
            ...
            return view('manage.kkgia.dkg.kekhaimhbog.kekhai.index')
                ...
                ->with('inputs',$inputs)
                ->with('modeldv',$modeldv)
                ->with('pageTitle', 'Danh sách hồ sơ kê khai giá mặt hàng BOG');
    ...
    public function edit($id){
        ...
        if (Session::has('admin')) {
            ...
            return view('manage.kkgia.dkg.kekhaimhbog.kekhai.edit')
                ...
                ->with('modelct',$modelct)
                ->with('dmnghe',$dmnghe)
                ->with('pageTitle', 'Chỉnh sửa hồ sơ kê khai giá mặt hàng BOG');
        }else
            return view('errors.notlogin');
    }
