...
class GiaNuocShCtDfController extends Controller
{
    public function store(Request $request){
        ...
        if(isset($inputs['doituong'])){
            ...
            $modeladd = new GiaNuocShCtDf();
            $modeladd->create($inputs);

            $model = GiaNuocShCtDf::where('mahuyen',$inputs['mahuyen'])
                    ->get();
    ...
    public function show(Request $request){
        ...
        if(isset($inputs['id'])){
            ...
            $model = GiaNuocShCtDf::findOrFail($id);
    ...
    public function update(Request $request){
        ...
        if(isset($inputs['doituong'])){
            ...
            $inputs['phibvmt'] = getMoneyToDb($inputs['phibvmt']);
            $inputs['thanhtien'] = getMoneyToDb($inputs['thanhtien']);
            $modeladd = GiaNuocShCtDf::where('id',$inputs['id'])->first();
            unset($inputs['id']);
