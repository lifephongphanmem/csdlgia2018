...
use App\KkGiaKcbTnCtDf;
use Illuminate\Http\Request;
use App\Http\Controllers\Controller;
use Illuminate\Support\Facades\Session;

class KkGiaKcbTnCtDfController extends Controller
{
    public function store(Request $request){
        ...
        if(isset($inputs['tthhdv'])){
            $modelkkgia = new KkGiaKcbTnCtDf();
            $modelkkgia->create($inputs);
            $model = KkGiaKcbTnCtDf::where('maxa',$inputs['maxa'])
                ->get();
    ...
    public function edit(Request $request){
        ...
        if(isset($inputs['id'])){
            $id = $inputs['id'];
            $model = KkGiaKcbTnCtDf::findOrFail($id);
    ...
    public function update(Request $request){
        ...
        $inputs['dongia'] = getMoneyToDb($inputs['dongia']);
        if(isset($inputs['id'])){
            $modelkkgia = KkGiaKcbTnCtDf::where('id',$inputs['id'])->first();
