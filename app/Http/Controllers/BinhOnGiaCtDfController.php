...
class BinhOnGiaCtDfController extends Controller
{
    public function add(Request $request){
        ...
        if(isset($inputs['tenhh'])){
            ...
            $modeladd = new BinhOnGiaCtDf();
            $modeladd->create($inputs);

            $model = BinhOnGiaCtDf::where('mahuyen',$inputs['mahuyen'])
                ->get();
    ...
    public function show(Request $request){
        ...
        if(isset($inputs['id'])){
            ...
            $model = BinhOnGiaCtDf::findOrFail($id);
            //dd($model);
    ...
    public function update(Request $request){
        ...
        if(isset($inputs['id'])){
            ...
            $inputs['giatoida'] = getMoneyToDb($inputs['giatoida']);
            $inputs['mahuyen'] = session('admin')->mahuyen != '' ? session('admin')->mahuyen : 'T' ;
            $modeladd = BinhOnGiaCtDf::where('id',$inputs['id'])->first();
            unset($inputs['id']);
    ...
    public function destroy(Request $request){
        ...
        if(isset($inputs['id'])){
            $inputs['mahuyen'] = session('admin')->mahuyen != '' ? session('admin')->mahuyen : 'T' ;
            $modeladd = BinhOnGiaCtDf::where('id',$inputs['id'])->delete();
