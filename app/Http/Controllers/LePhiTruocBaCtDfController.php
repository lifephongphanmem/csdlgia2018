...
class LePhiTruocBaCtDfController extends Controller
{
    ...
    public function show(Request $request){
        ...
        if(isset($inputs['id'])){
            ...
            $result['message'] .= '<div><input type="text" style="text-align: right" id="nhanhieuedit" name="nhanhieuedit" class="form-control" value="'.$model->nhanhieu.'"></div>';
            $result['message'] .= '</div>';
            $result['message'] .= '</div>';
            $result['message'] .= '<div class="col-md-6">';
            ...
            $result['message'] .= '<div><input type="text" style="text-align: right" id="ttlvedit" name="ttlvedit" class="form-control" value="'.$model->ttlv.'"></div>';
            $result['message'] .= '</div>';
            $result['message'] .= '</div>';
            $result['message'] .= '<div class="col-md-6">';
            $result['message'] .= '<div class="form-group"><label for="selGender" class="control-label"><b>Só chỗ ngồi</b><span class="require">*</span></label>';
