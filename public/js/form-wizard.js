$(function () {
    ...
    */
    ...
    $('#rootwizard-custom-circle input:not(.passvalid)').keyup(function() {
        if (!$(this).val()) {
            $(this).parent().removeClass('state-success').addClass('state-error');
        } else {
            $(this).parent().removeClass('state-error').addClass('state-success');
        }
        if($('#rootwizard-custom-circle :submit').hasClass('aftercheck')){
            if(!$(this).val()){
                $('#rootwizard-custom-circle :submit').addClass('disabled');
            } else {
                $('#rootwizard-custom-circle :submit').removeClass('disabled');
            }
        }
    });
    /**
    ...
    $("#btnnext").click(function(){
        setTimeout(function() {
            if($('#rootwizard-custom-circle li:eq(3)').hasClass('active')){
                $('#rootwizard-custom-circle :submit').removeClass('disabled').addClass('aftercheck');
            } else {
                $('#rootwizard-custom-circle :submit').addClass('disabled').removeClass('aftercheck');
            }
        }, 0);
    });
     */
