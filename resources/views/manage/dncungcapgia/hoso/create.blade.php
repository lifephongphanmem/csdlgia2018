...
@section('content')
    <h3 class="page-title">
        Hồ sơ cung cấp giá <b style="color: blue">{{$modeldn->tendn}}</b><small> thêm mới</small>
    </h3>
    <!-- END PAGE HEADER-->
    ...
    <div class="row center">
        <div class="col-md-12 center">
            ...
            {!! Form::open(['url'=>'hosocungcapgia', 'id' => 'create_thamdinhgia', 'files'=>true, 'class'=>'horizontal-form']) !!}
