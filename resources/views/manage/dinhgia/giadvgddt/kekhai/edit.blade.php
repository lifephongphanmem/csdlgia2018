...
@section('custom-script')
    ...
    <script>
        ...
        function updatemhbog(){
            var CSRF_TOKEN = $('meta[name="csrf-token"]').attr('content');
            $.ajax({
                url: '/thongtingiadvgddtct/update',
                type: 'GET',
                data: {
                    _token: CSRF_TOKEN,
                    id: $('#idedit').val(),
...
@section('content')
    <h3 class="page-title">
        Thông tin hồ sơ giá giáo dục đào tạo<small> chỉnh sửa</small>
    </h3>
    <!-- END PAGE HEADER-->
        ...
        <div class="col-md-12 center">
            ...
            <div class="portlet box blue">
                ...
                <div class="portlet-body form">
                    <!-- BEGIN FORM-->
                    {!! Form::model($model, ['method' => 'PATCH', 'url'=>'thongtingiadvgddt/'. $model->id, 'class'=>'horizontal-form','id'=>'update_thongtingiadvgddt']) !!}
    ...
    <script type="text/javascript">
        function validateForm(){
            ...
            var validator = $("#update_thongtingiadvgddt").validate({
                rules: {
                    ten :"required"
                },
                messages: {
