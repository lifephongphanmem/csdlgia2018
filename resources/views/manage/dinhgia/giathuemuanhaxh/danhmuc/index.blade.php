...
@section('custom-script')
    ...
    <script>
        ...
        function ClickEdit(id){
            ...
            $.ajax({
                url: 'danhmucgiathuemuanhaxh/show',
                type: 'GET',
                data: {
                    _token: CSRF_TOKEN,
                    id: id
...
@section('content')
    ...
    <h3 class="page-title">
        Danh mục nhóm <small>&nbsp;giá thuê mua nhà xã hội</small>
    </h3>
    <!-- END PAGE HEADER-->
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="portlet box">
                <div class="portlet-title">
                    <div class="actions">
                        @if(can('dmgiathuemuanhaxh','create'))
                    ...
                    <table class="table table-striped table-bordered table-hover" id="sample_3">
                        ...
                        <tr class="odd gradeX">
                            ...
                            <td>
                                ...
                                @endif
                                @if(can('dmgiathuemuanhaxh','delete'))
    ...
    <div class="modal fade" id="modal-create" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                {!! Form::open(['url'=>'danhmucgiathuemuanhaxh','id' => 'frm_create'])!!}
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                    <h4 class="modal-title">Thêm mới nhóm thuê mua nhà xã hội?</h4>
                </div>
    ...
    <div class="modal fade" id="modal-edit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                    <h4 class="modal-title">Chỉnh sửa nhóm thuê mua nhà xã hội?</h4>
                </div>
                {!! Form::open(['url'=>'danhmucgiathuemuanhaxh/update','id' => 'frm_update'])!!}
    ...
    <div class="modal fade" id="modal-delete" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                {!! Form::open(['url'=>'danhmucgiathuemuanhaxh/delete','id' => 'frm_delete'])!!}
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
