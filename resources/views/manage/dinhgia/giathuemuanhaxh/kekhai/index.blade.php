    ...
    <script>
        ...
        $(function(){
            $('#nam').change(function() {
                ...
                var url = '/thongtingiadvgddt?' + namhs;
                window.location.href = url;
            });
            $('#trangthai').change(function() {
                var namhs = '&nam=' + $('#nam').val();
                var trangthai = '&trangthai=' + $('#trangthai').val();
                var url = '/thongtingiadvgddt?' + namhs + trangthai;
                window.location.href = url;
            });
...
@section('content')
    ...
    <h3 class="page-title">
        Thông tin hồ sơ <small>&nbsp;giá thuê mua nhà xã hội</small>
    </h3>
    <!-- END PAGE HEADER-->
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="portlet box wi">
                <div class="portlet-title">
                    ...
                    <div class="actions">
                        @if(can('kkgiathuemuanhaxh','create'))
                ...
                <div class="portlet-body">
                    ...
                    <table class="table table-striped table-bordered table-hover" id="sample_3">
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{url('thongtingiathuemuanhaxh/'.$tt->id)}}" class="btn btn-default btn-xs mbs" target="_blank"><i class="fa fa-eye"></i>&nbsp;Xem chi tiết</a>
                                @if($tt->trangthai == 'CHT' || $tt->trangthai == 'HHT')
                                    @if(can('kkgiathuemuanhaxh','edit'))
                                    <a href="{{url('thongtingiathuemuanhaxh/'.$tt->id.'/edit')}}" class="btn btn-default btn-xs mbs">
                                        <i class="fa fa-edit"></i> Chỉnh sửa </a>
                                    @endif
                                    @if(can('kkgiathuemuanhaxh','approve'))
                                    ...
                                    @endif
                                    @if($tt->trangthai == 'CHT')
                                        @if(can('kkgiathuemuanhaxh','delete'))
                                ...
                                @if($tt->trangthai == 'HT' || $tt->trangthai == 'CB')
                                    @if(session('admin')->level == 'T' || session('admin')->level == 'H')
                                        @if($tt->trangthai == 'HT')
                                            @if(can('thgiathuemuanhaxh','congbo'))
    ...
    <div id="create-modal-confirm" tabindex="-1" role="dialog" aria-hidden="true" class="modal fade bs-modal-lg">
        {!! Form::open(['url'=>'thongtingiathuemuanhaxh/create','id' => 'frm_create','method'=>'post'])!!}
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header modal-header-primary">
                    <button type="button" data-dismiss="modal" aria-hidden="true" class="close">&times;</button>
                    <h4 id="modal-header-primary-label" class="modal-title">Thêm mới kê khai giá thuê mua nhà xã hội</h4>
                </div>
    ...
    <div class="modal fade" id="delete-modal-confirm" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                {!! Form::open(['url'=>'thongtingiathuemuanhaxh/delete','id' => 'frm_delete'])!!}
    ...
    <div id="hoanthanh-modal-confirm" tabindex="-1" role="dialog" aria-hidden="true" class="modal fade">
        {!! Form::open(['url'=>'thongtingiathuemuanhaxh/hoanthanh','id' => 'frm_hoanthanh'])!!}
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header modal-header-primary">
    ...
    <div id="huyhoanthanh-modal-confirm" tabindex="-1" role="dialog" aria-hidden="true" class="modal fade">
        {!! Form::open(['url'=>'thongtingiathuemuanhaxh/huyhoanthanh','id' => 'frm_huyhoanthanh'])!!}
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header modal-header-primary">
                    <button type="button" data-dismiss="modal" aria-hidden="true"
    ...
    <div id="congbo-modal-confirm" tabindex="-1" role="dialog" aria-hidden="true" class="modal fade">
        {!! Form::open(['url'=>'thongtingiathuemuanhaxh/congbo','id' => 'frm_congbo'])!!}
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header modal-header-primary">
                    <button type="button" data-dismiss="modal" aria-hidden="true"
