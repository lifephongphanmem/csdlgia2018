...
@section('custom-script')
    ...
    <script>
        ...
        function createmhbog(){
            ...
            $.ajax({
                url: '/thongtingiathuemuanhaxhctdf/store',
                type: 'GET',
                data: {
                    _token: CSRF_TOKEN,
                    loainha: $('#loainha').val(),
        ...
        function editmhbog(id) {
            ...
            //alert(id);
            $.ajax({
                url: '/thongtingiathuemuanhaxhctdf/show',
                type: 'GET',
                data: {
                    _token: CSRF_TOKEN,
                    id: id
        ...
        function updatemhbog(){
            var CSRF_TOKEN = $('meta[name="csrf-token"]').attr('content');
            $.ajax({
                url: '/thongtingiathuemuanhaxhctdf/update',
                type: 'GET',
                data: {
                    _token: CSRF_TOKEN,
                    id: $('#idedit').val(),
        ...
        function delmhbog() {
            var CSRF_TOKEN = $('meta[name="csrf-token"]').attr('content');
            $.ajax({
                url: '/thongtingiathuemuanhaxhctdf/del',
                type: 'GET',
                data: {
                    _token: CSRF_TOKEN,
...
@section('content')
    <h3 class="page-title">
        Thông tin hồ sơ giá thuê mua nhà xã hội<small> thêm mới</small>
    </h3>
    <!-- END PAGE HEADER-->
        ...
        <div class="col-md-12 center">
            ...
            <div class="portlet box blue">
                ...
                <div class="portlet-body form">
                    <!-- BEGIN FORM-->
                    {!! Form::open(['url'=>'thongtingiathuemuanhaxh', 'id' => 'create_thongtingiathuemuanhaxh', 'class'=>'horizontal-form']) !!}
