                ...
                <div class="portlet-title">
                    <div class="actions">
                        ...
                        <button type="button" class="btn btn-default btn-xs mbs" data-target="#delete-modal-confirm" data-toggle="modal"><i class="fa fa-trash-o"></i>&nbsp;
                            Xóa</button>
                        @endif
                        @if(can('thgiathuemuanhaxh','congbo') && (session('admin')->level == 'T' || session('admin')->level == 'H'))
                                            ...
                                            <td>
                                                {{--@if(session('admin')->level == 'T' || session('admin')->level == 'H')--}}
                                                    ...
                                                    {{--@else--}}
                                                        ...
                                                        {{--@endif--}}
                                                        {{--@if(can('thgiathuemuanhaxh','congbo'))--}}
                                                            {{--<button type="button" onclick="getIdCb('{{$tt->id}}')" class="btn btn-default btn-xs mbs" data-target="#congbo-modal" data-toggle="modal"><i class="fa fa-check"></i>&nbsp;--}}
                                                                {{--Công bố</button>--}}
                                                        {{--@endif--}}
