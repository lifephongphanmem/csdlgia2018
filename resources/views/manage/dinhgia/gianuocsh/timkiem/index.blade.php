...
@section('custom-script')
    ...
    <script>
        ...
        function searchtt(){
            var current_path_url = '/tkgianuocsachsinhhoat?';
            var nam = '&nam='+$('#nam').val();
        ...
        function resettt(){
            ...
            $("#soqd").val('');
            $("#mota").val('');
            window.location.href = '/tkgianuocsachsinhhoat';
        }
    </script>
@stop
...
@section('content')
    ...
    <h3 class="page-title">
        Danh sách<small>&nbsp;giá nước sạch sinh hoạt</small>
    </h3>
    <!-- END PAGE HEADER-->
    <div class="row">
        <div class="col-md-12">
                                ...
                                <div class="row">
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <label style="font-weight: bold">Năm công chứng</label>
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        {!! Form::text('soqd', $inputs['soqd'], ['id' => 'soqd', 'rows' => 4, 'cols' => 10, 'class' => 'form-control', 'placeholder' => 'Số quyết định']) !!}
                                    </div>
                                    <div class="col-md-2">
                            ...
                            @if($model->count() != 0)
                                @foreach($model as $key => $tt)
                                    <tr>
                                        ...
                                        <td style="text-align: center">{{$tt->doituongsd}}</td>
                                        <td style="text-align: center">{{number_format($tt->giachuathue)}}</td>
                                    </tr>
                                @endforeach
                            @else
                                <tr>
