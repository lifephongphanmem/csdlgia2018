...
@section('custom-script')
    ...
    <script>
        ...
        function createmhbog(){
            ...
            $.ajax({
                url: '/thongtingianuocsinhhoatctdf/store',
                type: 'GET',
                data: {
                    _token: CSRF_TOKEN,
        ...
        function editmhbog(id) {
            ...
            //alert(id);
            $.ajax({
                url: '/thongtingianuocsinhhoatctdf/show',
                type: 'GET',
                data: {
                    _token: CSRF_TOKEN,
                    id: id
        ...
        function updatemhbog(){
            var CSRF_TOKEN = $('meta[name="csrf-token"]').attr('content');
            $.ajax({
                url: '/thongtingianuocsinhhoatctdf/update',
                type: 'GET',
                data: {
                    _token: CSRF_TOKEN,
                    id: $('#idedit').val(),
        ...
        function delmhbog() {
            var CSRF_TOKEN = $('meta[name="csrf-token"]').attr('content');
            $.ajax({
                url: '/thongtingianuocsinhhoatctdf/del',
                type: 'GET',
                data: {
                    _token: CSRF_TOKEN,
...
@section('content')
        ...
        <div class="col-md-12 center">
            ...
            <div class="portlet box blue">
                ...
                <div class="portlet-body form">
                    <!-- BEGIN FORM-->
                    {!! Form::open(['url'=>'thongtingianuocsinhhoat', 'id' => 'create_thongtingianuocsinhhoat', 'class'=>'horizontal-form']) !!}
    ...
    <script type="text/javascript">
        function validateForm(){
            ...
            var validator = $("#create_thongtingianuocsinhhoat").validate({
                rules: {
                    ten :"required"
                },
                messages: {
