...
@section('custom-script')
    ...
    <script>
        ...
        $(function(){
            $('#nam').change(function() {
                var nam = '&nam=' + $('#nam').val();
                var url = 'timkiemthongtinthuetaisancong?' + nam ;
                window.location.href = url;
            });
            $('#tents').change(function() {
                var nam = '&nam=' + $('#nam').val();
                var tents = '&tents=' + $('#tents').val();
                var url = 'timkiemthongtinthuetaisancong?' + nam  + tents;
                window.location.href = url;
            });
            $('#maxa').change(function() {
                ...
                var url = 'timkiemthongtinthuetaisancong?' + nam  + tents + maxa;
                window.location.href = url;
            });
...
@section('content')
    ...
    <h3 class="page-title">
        Tìm kiếm thông tin <small>&nbsp;giá thuê tài sản công</small>
    </h3>
    <!-- END PAGE HEADER-->
    <div class="row">
        <div class="col-md-12">
