...
@section('custom-script')
    ...
    <script>
        ...
        function capnhatts(){
            ...
            $.ajax({
                url: '/thongtinthuetaisancongct/store',
                type: 'GET',
                data: {
                    _token: CSRF_TOKEN,
                    tents: $('#tents').val(),
        ...
        function editItem(id) {
            ...
            //alert(id);
            $.ajax({
                url: '/thongtinthuetaisancongct/show',
                type: 'GET',
                data: {
                    _token: CSRF_TOKEN,
                    id: id
        ...
        function delrow(){
            var CSRF_TOKEN = $('meta[name="csrf-token"]').attr('content');
            $.ajax({
                url: '/thongtinthuetaisancongct/del',
                type: 'GET',
                data: {
                    _token: CSRF_TOKEN,
...
@section('content')
    ...
    <div class="row center">
        <div class="col-md-12 center">
            ...
            {!! Form::model($model, ['method' => 'PATCH', 'url'=>'thongtinthuetaisancong/'. $model->id, 'class'=>'horizontal-form','id'=>'update_thongtinthuetaisancong']) !!}
