...
@section('content')
    ...
    <h3 class="page-title">
        Giá thuê<small>&nbsp;môi trường rừng</small>
    </h3>
    {{--<h3 class="page-title">
                ...
                <div class="portlet-title">
                    <div class="actions">
                        ...
                        <button type="button" class="btn btn-default btn-xs mbs" data-target="#add-modal" data-toggle="modal"><i class="fa fa-plus"></i>&nbsp;
                            Thêm mới</button>
                        <a href="{{url('giarung/nhandulieutuexcel')}}" class="btn btn-default btn-sm">
                        ...
                        @if(can('thgiarung','congbo') && (session('admin')->level == 'T' || session('admin')->level == 'H'))
                        <button type="button" class="btn btn-default btn-xs mbs" data-target="#check-modal-confirm" data-toggle="modal"><i class="fa fa-check"></i>&nbsp;
                            Công bố/ Hủy</button>
                        @endif
                        <a href="{{url('giarung/prints?&nam='.$inputs['nam'].'&district='.$inputs['district'].'&manhom='.$inputs['manhom'].'&tenduan='.$inputs['tenduan'])}}" class="btn btn-default btn-sm" target="_blank">
...
{{--                                            <td style="text-align: center">{{$tt->ghichu}}</td>--}}
    ...
    @include('manage.dinhgia.giarung.include.modal_dialog')
