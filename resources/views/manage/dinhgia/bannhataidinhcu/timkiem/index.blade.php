...
@section('custom-script')
    ...
    <script>
        ...
        $(function(){
            $('#nam').change(function() {
                var nam = '&nam=' + $('#nam').val();
                var url = 'timkiemthongtinbannhataidinhcu?' + nam ;
                window.location.href = url;
            });
            $('#manhom').change(function() {
                var manhom = '&manhom=' + $('#manhom').val();
                var nam = '&nam=' + $('#nam').val();
                var url = 'timkiemthongtinbannhataidinhcu?' + nam + manhom;
                window.location.href = url;
            });
            $('#loainha').change(function() {
                ...
                var nam = '&nam=' + $('#nam').val();
                var manhom = '&manhom=' + $('#manhom').val();
                var url = 'timkiemthongtinbannhataidinhcu?' + nam + manhom + loainha;
                window.location.href = url;
            });
...
@section('content')
    ...
    <h3 class="page-title">
        Tìm kiếm thông tin <small>&nbsp;bán nhà tái định cư</small>
    </h3>
    <!-- END PAGE HEADER-->
    <div class="row">
        <div class="col-md-12">
