...
@section('content')
    <h3 class="page-title">
        Hồ sơ giá tài sản công<small> chỉnh sửa</small>
    </h3>
    <!-- END PAGE HEADER-->
    ...
    <div class="row center">
        <div class="col-md-12 center">
            ...
            {!! Form::model($model, ['method' => 'PATCH', 'url'=>'giataisancong/'. $model->id, 'class'=>'horizontal-form','id'=>'update_thongtindaugiadat']) !!}
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    {!!Form::text('thoidiemden',isset($model) ? date('d/m/Y',  strtotime($model->thoidiemden)) : null , array('id' => 'thoidiemden','data-inputmask'=>"'alias': 'date'",'class' => 'form-control required'))!!}
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    {!!Form::select('mataisan', $a_dm, null, array('id' => 'mataisan','class' => 'form-control required','autofocus'))!!}
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    {!!Form::text('giathue',null, array('id' => 'giathue','data-mask'=>'fdecimal','class' => 'form-control required'))!!}
                                </div>
                            </div>
                        </div>
                        <div class="row">
            ...
            <div class="row">
                <div class="col-md-12" style="text-align: center">
                    <a href="{{url('giataisancong')}}" class="btn btn-danger"><i class="fa fa-reply"></i>&nbsp;Quay lại</a>
