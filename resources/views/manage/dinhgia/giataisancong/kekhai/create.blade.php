...
@section('content')
    <h3 class="page-title">
        Hồ sơ giá tài sản công<small> thêm mới</small>
    </h3>
    <!-- END PAGE HEADER-->
    ...
    <div class="row center">
        <div class="col-md-12 center">
            ...
            {!! Form::open(['url'=>'giataisancong', 'id' => 'create_thongtindaugiadat', 'class'=>'horizontal-form']) !!}
            ...
            <div class="row">
                <div class="col-md-12" style="text-align: center">
                    <a href="{{url('giataisancong?&mahuyen='.$modeldb->district)}}" class="btn btn-danger"><i class="fa fa-reply"></i>&nbsp;Quay lại</a>
