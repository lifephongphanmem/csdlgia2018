...
@section('content')
    <h3 class="page-title">
        Bảng giá tính thuế tài nguyên trên địa bàn<small> chỉnh sửa</small>
    </h3>
    <!-- END PAGE HEADER-->
    <hr>
    ...
    <div class="row center">
        <div class="col-md-12 center">
            ...
            {!! Form::model($model, ['method' => 'PATCH', 'url'=>'thuetainguyen/'. $model->id, 'class'=>'horizontal-form','id'=>'update_giathitruong']) !!}
            ...
            <div class="row">
                <div class="col-md-12" style="text-align: center">
                    <a href="{{url('thuetainguyen?&manhom='.$model->manhom)}}" class="btn btn-danger"><i class="fa fa-reply"></i>&nbsp;Quay lại</a>
