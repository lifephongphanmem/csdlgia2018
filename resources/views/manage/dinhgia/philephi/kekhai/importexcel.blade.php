...
@section('content')
        ...
        <div class="col-md-12 center">
            ...
            <div class="portlet box blue">
                <div class="portlet-body form">
                    <!-- BEGIN FORM -->
                    {!! Form::open(['url'=>'/philephi/importexcel', 'method'=>'post' , 'files'=>true, 'id' => 'create_hscb','enctype'=>'multipart/form-data']) !!}
                                    ...
                                    <!-- BEGIN PORTLET-->
                                        <div class="portlet-body" style="display: block;">
                                            <div class="form-body">
                                                ...
                                                <input type="hidden" name="mahs" value="{{$inputs['mahs']}}">
                                                <div class="row">
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            <label class="control-label">Tên phí, lệ phí<span class="require">*</span></label>
                                                            {!!Form::text('ptcp', 'A', array('id' => 'ptcp','class' => 'form-control required'))!!}
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            <label class="control-label">Mức phí<span class="require">*</span></label>
                                                            {!!Form::text('mucthuphi', 'B', array('id' => 'mucthuphi','class' => 'form-control required'))!!}
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            {!!Form::text('ghichu', 'C', array('id' => 'ghichu','class' => 'form-control required'))!!}
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <div class="form-group">
    ...
    <script>
        function ClickCreate(){
            ...
            if (!$('#ptcp').val()) {
                str += '  - Tên phí, lệ phí \n';
                $('#ptcp').parent().addClass('has-error');
                ok = false;
            }

            if (!$('#mucthuphi').val()) {
                str += '  - Mức phí \n';
                $('#mucthuphi').parent().addClass('has-error');
                ok = false;
            }
