...
@section('content')
    ...
    <h3 class="page-title">
        Thông tin hồ sơ phí, lệ phí<small> thêm mới</small>
    </h3>
    <!-- END PAGE HEADER-->
        ...
        <div class="col-md-12 center">
            ...
            <div class="portlet box blue">
                ...
                <div class="portlet-body form">
                    <!-- BEGIN FORM-->
                    {!! Form::open(['url'=>'philephi', 'id' => 'create_philephi', 'class'=>'horizontal-form']) !!}
    ...
    <script type="text/javascript">
        function validateForm(){
            ...
            var validator = $("#create_philephi").validate({
                rules: {
                    ten :"required"
                },
                messages: {
