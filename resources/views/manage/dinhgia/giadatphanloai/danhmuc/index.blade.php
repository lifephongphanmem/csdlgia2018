...
@section('content')
    ...
    <h3 class="page-title">
        Thông tin danh mục các loại đất<small>&nbsp;theo phân loại</small>
    </h3>
    <!-- END PAGE HEADER-->
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="portlet box wi">
                <div class="portlet-title">
                    ...
                    <div class="actions">
                        ...
                        <a href="{{url('giadatphanloaidm/create')}}" class="btn btn-default btn-sm">
                ...
                <div class="portlet-body">
                    ...
                    <table class="table table-striped table-bordered table-hover" id="sample_3">
                        ...
                        <tr>
                            ...
                            <td class="success">{{$tt->tenvitri}}</td>
                            <td class="text-center">{{dinhdangso($tt->giatri)}}</td>
                            <td>{{$tt->loaidat}}</td>
                            <td>
                                @if(can('kkgiacldat','edit'))
                                <a href="{{url('giadatphanloaidm/'.$tt->id.'/edit')}}" class="btn btn-default btn-xs mbs">
    ...
    <div class="modal fade" id="delete-modal-confirm" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                {!! Form::open(['url'=>'giadatphanloaidm/delete','id' => 'frm_delete'])!!}
