...
@section('custom-script')
    ...
    <script>
        ...
        function resettt(){
            window.location.href = '/giadatphanloai';
        }
                    ...
                    <div class="actions">
                        @if(can('kkgiacldat','create'))
                            @if($inputs['mahuyen'] != 'all')
                                <a href="{{url('giadatphanloai/create?&mahuyen='.$inputs['mahuyen'])}}" class="btn btn-default btn-sm">
                        ...
                        @endif
                        <a href="{{url('giadatphanloai/print?&mahuyen='.$inputs['mahuyen'].'&nam='.$inputs['nam'].'&tenphanloai='.$inputs['tenphanloai']).'&maxa='.$inputs['maxa']}}"
