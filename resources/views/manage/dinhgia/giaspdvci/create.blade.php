...
@section('content')
    <h3 class="page-title">
        ...
        kinh doanh sử dụng ngân sách địa phương theo quy định của pháp luật<small> thêm mới</small>
    </h3>
    <hr>
    <div class="row">
        {!! Form::open(['url'=>'giaspdvci', 'id' => 'create_kkdvlt', 'class'=>'horizontal-form']) !!}
        <div class="col-md-12">
