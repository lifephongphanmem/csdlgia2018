...
@section('content')
    <h3 class="page-title">
        Danh mục nhóm  <small>&nbsp;dịch vụ khám chữa bệnh</small>
    </h3>
    <!-- END PAGE HEADER-->
    <div class="row">
        <div class="col-md-12">
    ...
    <div class="modal fade" id="modal-create" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                {!! Form::open(['url'=>'nhomdichvukcb','id' => 'frm_create'])!!}
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                    <h4 class="modal-title">Thêm mới nhóm dịch vụ khám chữa bệnh?</h4>
                </div>
    ...
    <div class="modal fade" id="modal-edit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                    <h4 class="modal-title">Chỉnh sửa nhóm dịch vụ khám chữa bệnh?</h4>
                </div>
                {!! Form::open(['url'=>'nhomdichvukcb/update','id' => 'frm_update'])!!}
