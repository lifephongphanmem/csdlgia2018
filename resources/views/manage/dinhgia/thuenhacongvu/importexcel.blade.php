...
@section('content')
    ...
    <h3 class="page-title">Nhận dữ liệu giá thuê nhà ở công vụ<small> từ file Excel</small> </h3>
    <!-- END PAGE HEADER-->
        ...
        <div class="col-md-12 center">
            ...
            <div class="portlet box blue">
                <div class="portlet-body form">
                    <!-- BEGIN FORM -->
                    {!! Form::open(['url'=>'/giathuenhacongvu/importexcel', 'method'=>'post' , 'files'=>true, 'id' => 'create_hscb','enctype'=>'multipart/form-data']) !!}
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            {!!Form::text('dongiathue', 'D', array('id' => 'dongiathue','class' => 'form-control required'))!!}
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <div class="form-group">
            ...
            <div class="col-md-12" style="text-align: center">
                <a href="{{url('giathuenhacongvu')}}" class="btn btn-danger"><i class="fa fa-reply"></i>&nbsp;Quay lại</a>
    ...
    <script>
        function ClickCreate(){
            ...
            if (!$('#dongiathue').val()) {
                str += '  - Đơn giá thuê \n';
                $('#dongiathue').parent().addClass('has-error');
                ok = false;
            }
