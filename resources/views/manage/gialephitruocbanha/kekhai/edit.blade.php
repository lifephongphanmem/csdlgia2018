...
@section('content')
    ...
    <h3 class="page-title">
        Thông tin hồ sơ lệ phí trước bạ đối với nhà<small> chỉnh sửa</small>
    </h3>
    <!-- END PAGE HEADER-->
        ...
        <div class="col-md-12 center">
            ...
            <div class="portlet box blue">
                ...
                <div class="portlet-body form">
                    <!-- BEGIN FORM-->
                    {!! Form::model($model, ['method' => 'PATCH', 'url'=>'lephitruocbanha/'. $model->id, 'class'=>'horizontal-form','id'=>'update_lephitruocba']) !!}
