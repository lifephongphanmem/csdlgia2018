<!DOCTYPE html>
<html lang="en">
<head><title>Đã tồn tại báo cáo</title>
    <meta charset="utf-8">
...
<div id="error-page-content"><h1>Lỗi!</h1><h4>Đã tồn tại báo cáo giá thị trường Tháng {{$inputs['add_thang']}} /Năm {{$inputs['add_nam']}} của {{$modeldv->tendv}}!</h4></div>
<p><a href='{{ url('kekhaigiathitruong?&mahuyen='.$inputs['add_mahuyen'].'&nam='.$inputs['add_nam']) }}'>Bấm vào đây</a> để quay lại.</p>
