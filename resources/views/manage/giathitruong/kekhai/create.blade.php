...
@section('content')
    ...
    <div class="row center">
        <div class="col-md-12 center">
            ...
            {!! Form::open(['url'=>'kekhaigiathitruong', 'id' => 'create_giathitruong', 'class'=>'horizontal-form']) !!}
            <div class="portlet box blue">
                <div class="portlet-body form">
                    ...
                    <div class="form-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <label class="control-label" style="color: blue;font-weight: bold">{{$inputs['add_thang']}}</label>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                        ...
                        <input type="hidden" name="mahuyen" id="mahuyen" value="{{$inputs['add_mahuyen']}}">
                        <input type="hidden" name="matt" id="matt" value="{{$inputs['add_matt']}}">
                        <input type="hidden" name="thang" id="thang" value="{{$inputs['add_thang']}}">
            ...
            <div class="row">
                <div class="col-md-12" style="text-align: center">
                    <a href="{{url('kekhaigiathitruong?&mahuyen='.$inputs['add_mahuyen'].'&nam='.$inputs['add_nam'])}}" class="btn btn-danger"><i class="fa fa-reply"></i>&nbsp;Quay lại</a>
