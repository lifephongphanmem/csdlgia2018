...
@section('content')
        ...
        <div class="col-md-12 center">
            ...
            <div class="portlet box blue">
                <div class="portlet-body form">
                    <!-- BEGIN FORM -->
                    {!! Form::open(['url'=>'/kekhaigiaetanol/import_excel', 'method'=>'post' , 'files'=>true, 'id' => 'create_hscb','enctype'=>'multipart/form-data']) !!}
                                                ...
                                                <div class="row">
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            {!!Form::text('tthhdv', 'A', array('id' => 'tthhdv','class' => 'form-control required'))!!}
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            {!!Form::text('dongialk', 'E', array('id' => 'dongialk','class' => 'form-control required'))!!}
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            <label class="control-label">Mức giá kê khai<span class="require">*</span></label>
                                                            {!!Form::text('dongia', 'F', array('id' => 'dongia','class' => 'form-control required'))!!}
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <div class="form-group">
            ...
            <div class="col-md-12" style="text-align: center">
                <a href="{{url('kekhaigiaetanol?&masothue='.$inputs['maxa'])}}" class="btn btn-danger"><i class="fa fa-reply"></i>&nbsp;Quay lại</a>
    ...
    <script>
        function ClickCreate(){
            ...
            if (!$('#tthhdv').val()) {
                str += '  - Tên hàng hóa \n';
                $('#tthhdv').parent().addClass('has-error');
                ok = false;
            }
