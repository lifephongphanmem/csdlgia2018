...
@section('content')
    ...
    <!-- END PAGE HEADER-->
    <div class="row">
        {!! Form::open(['url'=>'thongtinkkdvhoatdongthuongmai', 'id' => 'create_kkdvhdtm', 'class'=>'horizontal-form']) !!}
        <div class="col-md-12">
            ...
            <div style="text-align: center">
                <a href="{{url('thongtinkkdvhoatdongthuongmai?&masothue='.$inputs['masothue'])}}" class="btn btn-danger"><i class="fa fa-reply"></i>&nbsp;Quay lại</a>
    ...
    <script type="text/javascript">
        function validateForm(){
            ...
            var validator = $("#create_kkdvhdtm").validate({
                rules: {
                    ten :"required"
                },
                messages: {
