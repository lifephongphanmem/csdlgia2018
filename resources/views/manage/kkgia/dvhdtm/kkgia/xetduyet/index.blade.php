    ...
    <script>
        ...
        $(function(){
            $('#nam').change(function() {
                ...
                var url = '/xetduyetkkgiadvhdtm?'+namhs;
                window.location.href = url;
            });
            $('#trangthai').change(function() {
                var namhs = '&nam=' + $('#nam').val();
                var trangthai = '&trangthai=' +  $('#trangthai').val();
                var url = '/xetduyetkkgiadvhdtm?'+namhs+trangthai;
                window.location.href = url;
            });
            $('#mahuyen').change(function() {
                ...
                var url = '/xetduyetkkgiadvhdtm?'+namhs+trangthai+mahuyen;
                window.location.href = url;
            });
        ...
        function confirmNhanHs(id){
            ...
            //alert(id);
            $.ajax({
                url: '/xetduyetkkgiadvhdtm/ttnhanhs',
                type: 'GET',
                data: {
                    _token: CSRF_TOKEN,
                    id: id
...
@section('content')
    ...
    <h3 class="page-title">
        Thông tin xét duyệt kê khai giá<small>&nbsp;dịch vụ hỗ trợ hoạt động thương mại</small>
    </h3>
    <div class="row">
        <div class="col-md-2">
        ...
        <div class="modal fade" id="tralai-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    {!! Form::open(['url'=>'xetduyetkkgiadvhdtm/tralai','id' => 'frm_tralai'])!!}
    ...
    <div class="modal fade" id="nhanhs-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                {!! Form::open(['url'=>'xetduyetkkgiadvhdtm/nhanhs','id' => 'frm_nhanhs'])!!}
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
    ...
    <div class="modal fade" id="nhanhsedit-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                {!! Form::open(['url'=>'xetduyetkkgiadvhdtm/nhanhsedit','id' => 'frm_nhanhsedit'])!!}
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
    ...
    <div class="modal fade" id="huyduyet-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                {!! Form::open(['url'=>'xetduyetkkgiadvhdtm/huyduyet','id' => 'frm_huyduyet'])!!}
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
