...
@section('content')
    <h3 class="page-title">
        Thông tin kê khai hồ sơ giá <small>&nbsp;xi măng, thép xây dựng chỉnh sửa</small>
        <p><h5 style="color: blue">{{$modeldn->tendn}}&nbsp;- Mã số thuế: {{$modeldn->maxa}}</h5></p>
    </h3>
    <!-- END PAGE HEADER-->
    <div class="row">
        {!! Form::model($model, ['method' => 'PATCH', 'url'=>'thongtinkekhaiximangthepxaydung/'. $model->id, 'class'=>'horizontal-form','id'=>'update_kkgiavlxd']) !!}
        <div class="col-md-12">
            ...
            <div style="text-align: center">
                <a href="{{url('thongtinkekhaigiavatlieuxaydung?&masothue='.$model->maxa)}}" class="btn btn-danger"><i class="fa fa-reply"></i>&nbsp;Quay lại</a>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body" id="ttpthemmoi">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group"><label for="selGender" class="control-label"><b>Tên xi măng, thép xây dựng</b><span class="require">*</span></label>
