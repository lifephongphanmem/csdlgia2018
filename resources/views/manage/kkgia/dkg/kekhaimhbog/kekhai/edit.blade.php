        ...
        <div class="col-md-12 center">
            ...
            <div class="portlet box blue">
                ...
                <div class="portlet-body form">
                    <!-- BEGIN FORM-->
                    {!! Form::model($model, ['method' => 'PATCH', 'url'=>'kkgiamhbog/'. $model->id, 'class'=>'horizontal-form','id'=>'update_kkdkg', 'files'=>true]) !!}
            ...
            <div style="text-align: center">
                <a href="{{url('kkgiamhbog?&manghe='.$model->phanloai.'&maxa='.$model->maxa)}}" class="btn btn-danger"><i class="fa fa-reply"></i>&nbsp;Quay lại</a>
