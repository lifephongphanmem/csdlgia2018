...
@section('custom-script')
    ...
    <script>
        ...
        $(function(){
            $('#nam').change(function() {
                var namhs = $('#nam').val();
                var url = '/timkiemgiaxemaynksx?'+namhs;
                window.location.href = url;
            });
            $('#tthhdv').change(function() {
                var namhs = '&nam='+ $('#nam').val();
                var tthhdv = '&tthhdv=' + $('#tthhdv').val();
                var url = '/timkiemgiaxemaynksx?'+namhs + tthhdv;
                window.location.href = url;
            });
...
@section('content')
    <h3 class="page-title">
        Tìm kiếm thông tin kê khai giá<small>&nbsp;xe máy nhập khẩu, sản xuất trong nước </small>
    </h3>
    <hr>
    <div class="row">
        <div class="col-md-2">
