...
@section('content')
    <h3 class="page-title">
        Thông tin kê khai hồ sơ giá <small>&nbsp;dịch vụ tại cảng biển, cảng hàng không chỉnh sửa</small>
        <p><h5 style="color: blue">{{$modeldn->tendn}}&nbsp;- Mã số thuế: {{$modeldn->maxa}}</h5></p>
    </h3>
    <!-- END PAGE HEADER-->
    <div class="row">
        {!! Form::model($model, ['method' => 'PATCH', 'url'=>'kekhaigiadvcang/'. $model->id, 'class'=>'horizontal-form','id'=>'update_kkgiavtxb']) !!}
        <div class="col-md-12">
            ...
            <div style="text-align: center">
                <a href="{{url('kekhaigiadvcang?&masothue='.$model->maxa)}}" class="btn btn-danger"><i class="fa fa-reply"></i>&nbsp;Quay lại</a>
