...
@section('content')
    <h3 class="page-title">
        Thông tin kê khai hồ sơ giá <small>&nbsp;vé tham quan khu du lịch trên địa bàn tỉnh thêm mới</small>
        <p><h5 style="color: blue">{{$modeldn->tendn}}&nbsp;- Mã số thuế: {{$modeldn->maxa}}</h5></p>
    </h3>
    <hr>
    <!-- END PAGE HEADER-->
    <div class="row">
        {!! Form::open(['url'=>'kekhaigiavetqkdl', 'id' => 'create_kkvtxk', 'class'=>'horizontal-form']) !!}
        <div class="col-md-12">
            ...
            <div style="text-align: center">
                <a href="{{url('kekhaigiavetqkdl?&masothue='.$inputs['masothue'])}}" class="btn btn-danger"><i class="fa fa-reply"></i>&nbsp;Quay lại</a>
