...
@section('custom-script')
    ...
    <script>
        ...
        $(function(){
            $('#nam').change(function() {
                var namhs = $('#nam').val();
                var url = '/timkiemgiavetqkdl?'+namhs;
                window.location.href = url;
            });
            $('#tthhdv').change(function() {
                var namhs = '&nam='+ $('#nam').val();
                var tthhdv = '&tthhdv=' + $('#tthhdv').val();
                var url = '/timkiemgiavetqkdl?'+namhs + tthhdv;
                window.location.href = url;
            });
...
@section('content')
    <h3 class="page-title">
        Tìm kiếm thông tin kê khai giá<small>&nbsp;vé tham quan khu du lịch trên địa bàn tỉnh</small>
    </h3>
    <hr>
    <div class="row">
        <div class="col-md-2">
