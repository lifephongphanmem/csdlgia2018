...
@section('content')
    ...
    <!-- END PAGE HEADER-->
    <div class="row">
        {!! Form::model($model, ['method' => 'PATCH', 'url'=>'thongtinkekhaigiavatlieuxaydung/'. $model->id, 'class'=>'horizontal-form','id'=>'update_kkgiavlxd']) !!}
        <div class="col-md-12">
    ...
    <script type="text/javascript">
        function validateForm(){
            ...
            var validator = $("#update_kkgiavlxd").validate({
                rules: {
                    ten :"required"
                },
                messages: {
