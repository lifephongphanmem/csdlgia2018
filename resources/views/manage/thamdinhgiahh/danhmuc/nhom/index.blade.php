...
@section('content')
    <h3 class="page-title">
        Danh mục nhóm  <small>&nbsp;thẩm định giá hàng hóa</small>
    </h3>
    <!-- END PAGE HEADER-->
    <div class="row">
        <div class="col-md-12">
                    ...
                    <table class="table table-striped table-bordered table-hover" id="sample_3">
                        ...
                        <tr class="odd gradeX">
                            ...
                            <td>
                                ...
                                @if($tt->theodoi == 'TD')
                                <a href="{{url('dmctthamdinhgiahh?&manhom='.$tt->manhom)}}" class="btn btn-default btn-xs mbs"><i class="fa fa-eye"></i>&nbsp;Xem chi tiết</a>
                                @endif
                            </td>
                        </tr>
                        @endforeach
    ...
    <div class="modal fade" id="modal-create" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                {!! Form::open(['url'=>'dmthamdinhgiahh','id' => 'frm_create'])!!}
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                    <h4 class="modal-title">Thêm mới nhóm thẩm định giá hàng hóa?</h4>
                </div>
    ...
    <div class="modal fade" id="modal-edit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                {!! Form::open(['url'=>'dmthamdinhgiahh/update','id' => 'frm_update'])!!}
