...
@section('content')
    ...
    <h3 class="page-title">
        Thông tin mặt hàng {{$modelmh->tenmh}} bình ổn giá<small> thêm mới</small>
    </h3>
    <!-- END PAGE HEADER-->
        ...
        <div class="col-md-12 center">
            ...
            <div class="portlet box blue">
                ...
                <div class="portlet-body form">
                    <!-- BEGIN FORM-->
                    {!! Form::open(['url'=>'binhongia', 'id' => 'create_binhongia', 'class'=>'horizontal-form']) !!}
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        {!!Form::time('gioapdung','09:00', array('id' => 'gioapdung','class' => 'form-control required'))!!}
                                    </div>
                                </div>
            ...
            <div style="text-align: center">
                <a href="{{url('binhongia?&mamh='.$mamh)}}" class="btn btn-danger"><i class="fa fa-reply"></i>&nbsp;Quay lại</a>
