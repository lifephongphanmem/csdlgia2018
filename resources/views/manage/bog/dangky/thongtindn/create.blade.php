        ...
        <div class="col-md-12 center">
            ...
            <div class="portlet box blue">
                ...
                <div class="portlet-body form">
                    <!-- BEGIN FORM-->
                    {!! Form::open(['url'=>'storednbog', 'id' => 'storednbog', 'class'=>'horizontal-form']) !!}
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <div class="input-icon">
                                            ...
                                            <input class="form-control placeholder-no-fix" type="text" placeholder="Số giấy phép đăng ký kinh doanh" name="giayphepkd" id="giayphepkd" >
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <div class="input-icon">
                                            ...
                                            <input class="form-control required" type="text" placeholder="Sản xuất hay dịch vụ" name="phanloaidn" id="phanloaidn">
                                        </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <div class="input-icon">
                                            <i class="fa fa-file"></i>
                                            <input class="form-control required" type="text" placeholder="Ghi chú" name="ghichu" id="ghichu">
                                        </div>
