...
@section('custom-script')
    ...
    <script>
        ...
        $(function(){
            ...
            $('#nam').change(function() {
                var nam = '&nam=' +$('#nam').val();
                var url = 'baocaochisogiatieudung?'  + nam;
...
@section('content')
    ...
    <h3 class="page-title">
       Báo cáo chỉ số giá tiêu dùng<small>&nbsp;(CPI)</small>
    </h3>
        ...
        <div class="col-md-12">
            ...
            <div class="portlet box">
                    <div class="portlet-title">
                        ...
                        <div class="actions">
                            @if(can('chisogiatieudung','create'))
                            <a href="{{url('baocaochisogiatieudung/create')}}" class="btn btn-default btn-sm">
                            ...
                            <tr>
                                ...
                                <td style="text-align: center">
                                    @if($tt->trangthai == 'HT')
                                        ...
                                        {{$tt->congbo == 'CB' ? 'Đang công bố' : 'Chưa công bố'}}
                                ...
                                <td>
                                    ...
                                    @if($tt->trangthai == 'CHT' || $tt->trangthai == 'HHT')
                                        @if(session('admin')->mahuyen == $tt->mahuyen)
                                            ...
                                            @endif
                                            @if(can('chisogiatieudung','delete'))
                                                @if($tt->trangthai == 'CHT')
                                    ...
                                    @if($tt->trangthai == 'HT' || $tt->trangthai == 'CB')
                                        @if(session('admin')->level == 'T' || session('admin')->level == 'H')
                                            @if($tt->trangthai == 'HT')
                                                @if(can('chisogiatieudung','congbo'))
                                                    @if($tt->congbo != 'CB')
    ...
    <div id="delete-modal-confirm" tabindex="-1" role="dialog" aria-hidden="true" class="modal fade">
        {!! Form::open(['url'=>'baocaochisogiatieudung/delete','id' => 'frm_delete'])!!}
    ...
    <div id="hoanthanh-modal-confirm" tabindex="-1" role="dialog" aria-hidden="true" class="modal fade">
        {!! Form::open(['url'=>'baocaochisogiatieudung/hoanthanh','id' => 'frm_hoanthanh'])!!}
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header modal-header-primary">
                    <button type="button" data-dismiss="modal" aria-hidden="true"
    ...
    <div id="huyhoanthanh-modal-confirm" tabindex="-1" role="dialog" aria-hidden="true" class="modal fade">
        {!! Form::open(['url'=>'baocaochisogiatieudung/huyhoanthanh','id' => 'frm_huyhoanthanh'])!!}
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header modal-header-primary">
                    <button type="button" data-dismiss="modal" aria-hidden="true"
    ...
    <div id="congbo-modal-confirm" tabindex="-1" role="dialog" aria-hidden="true" class="modal fade">
        {!! Form::open(['url'=>'baocaochisogiatieudung/congbo','id' => 'frm_congbo'])!!}
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header modal-header-primary">
                    <button type="button" data-dismiss="modal" aria-hidden="true"
