                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <table class="table table-striped table-bordered table-hover">
                                ...
                                <tbody>
                                <tr>
                                    <td><input type="checkbox" {{ (isset($permission->ttqdgiacldat->index) && $permission->ttqdgiacldat->index == 1) ? 'checked' : '' }} value="1" name="roles[ttqdgiacldat][index]"/></td>
                                    <td>Xem</td>
                                </tr>
                                <tr>
                                    <td><input type="checkbox" {{ (isset($permission->ttqdgiacldat->create) && $permission->ttqdgiacldat->create == 1) ? 'checked' : '' }} value="1" name="roles[ttqdgiacldat][create]"/></td>
                                    <td>Thêm mới</td>
                                </tr>
                                <tr>
                                    <td><input type="checkbox" {{ (isset($permission->ttqdgiacldat->edit) && $permission->ttqdgiacldat->edit == 1) ? 'checked' : '' }} value="1" name="roles[ttqdgiacldat][edit]"/></td>
                                    <td>Chỉnh sửa</td>
                                </tr>
                                <tr>
                                    <td><input type="checkbox" {{ (isset($permission->ttqdgiacldat->delete) && $permission->ttqdgiacldat->delete == 1) ? 'checked' : '' }} value="1" name="roles[ttqdgiacldat][delete]"/></td>
                                    <td>Xóa</td>
                                </tr>
                                </tbody>
                            </table>
