...
<head>
	<meta charset="utf-8"/>
	<title>Mã đăng ký tài khoản</title>
...
<div class="content">
	...
	<div class="form-group">
		<div class="input-icon">
			...
			<input class="form-control placeholder-no-fix" type="text" autocomplete="off" placeholder="Mã đăng ký tài khoản" name="ma" id="ma" required/>
		</div>
	</div>
...
<script type="text/javascript">
	function validatePassword(){
		...
		var validator = $("#form-registershow").validate({
			rules: {
				ten :"required"
			},
			messages: {
