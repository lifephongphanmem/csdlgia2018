                ...
                <div class="portlet-body">
                    ...
                    <table class="table table-striped table-bordered table-hover" id="sample_3">
                        ...
                        <tr>
                            ...
                            <th style="text-align: center" width="20%">Mã nhóm hàng hóa</th>
                        ...
                        @foreach($model as $key=>$tt)
                            <tr>
                                ...
                                <td>
                                    <a href="{{url('dmhanghoa-xuatnhapkhau/nhom='.$tt->manhom)}}" class="btn btn-default btn-xs mbs"><i class="fa fa-eye"></i>&nbsp;Chi tiết</a>
                                </td>
                            </tr>
                        @endforeach
