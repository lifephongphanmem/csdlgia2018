...
@section('content')
    ...
    <h3 class="page-title">
        Danh mục thông tin<small>&nbsp;thị trường hàng hóa</small>
    </h3>
    <!-- END PAGE HEADER-->
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="portlet box wi">
                <div class="portlet-title">
                    ...
                    <div class="actions">
                        <a href="{{url('dmthitruong/create')}}" class="btn btn-default btn-sm">
                ...
                <div class="portlet-body">
                    ...
                    <table class="table table-striped table-bordered table-hover" id="sample_3">
                        ...
                        <tr>
                            ...
                            <th style="text-align: center">Thị trường hàng hóa</th>
                        ...
                        <tr>
                            ...
                            <td class="success">{{$tt->thitruong}}</td>
                            <td>{{$tt->ghichu}}</td>
                            <td>
                                <a href="{{url('dmthitruong/'.$tt->id.'/edit')}}" class="btn btn-default btn-xs mbs">
    ...
    <div class="modal fade" id="delete-modal-confirm" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                {!! Form::open(['url'=>'dmthitruong/delete','id' => 'frm_delete'])!!}
