...
@section('content')
    ...
    <h3 class="page-title">
        Danh mục mặt hàng<small>&nbsp;trong nước</small>
    </h3>
    <h4 style="color: #0000ff">Nhóm hàng hóa: {{$tennhom}} - Phân nhóm hàng hóa: {{$tenpnhom}}</h4>
    <!-- END PAGE HEADER-->
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="portlet box">
                <div class="portlet-title">
                    ...
                    <div class="actions">
                        <a href="{{url('dmhanghoa-trongnuoc/nhom='.$nhom.'/pnhom='.$pnhom.'/create')}}" class="btn btn-default btn-sm">
                    ...
                    <table class="table table-striped table-bordered table-hover" id="sample_3">
                        ...
                        @foreach($model as $key=>$tt)
                            <tr>
                                ...
                                <td>
                                    <a href="{{url('dmhanghoa-trongnuoc/'.$tt->id.'/edit')}}" class="btn btn-default btn-xs mbs"><i class="fa fa-eye"></i>&nbsp;Chi tiết</a>
    ...
    <div class="modal fade" id="delete-modal-confirm" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                {!! Form::open(['url'=>'dmhanghoa-trongnuoc/delete','id' => 'frm_delete'])!!}
