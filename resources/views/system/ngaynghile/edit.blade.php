...
@section('content')
        ...
        <div class="col-md-12 center">
            ...
            <div class="portlet box blue">
                ...
                <div class="portlet-body form">
                    <!-- BEGIN FORM-->
                    {!! Form::model($model, ['method' => 'PATCH', 'url'=>'thongtinngaynghile/'. $model->id, 'class'=>'horizontal-form','id'=>'update_thongtinngaynghile']) !!}
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    {!!Form::text('tungay',date('d/m/Y',  strtotime($model->tungay)), array('id' => 'tungay','data-inputmask'=>"'alias': 'date'",'class' => 'form-control required'))!!}
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="control-label">Từ ngày<span class="require">*</span></label>
                                    {!!Form::text('denngay',date('d/m/Y',  strtotime($model->denngay)), array('id' => 'denngay','data-inputmask'=>"'alias': 'date'",'class' => 'form-control required'))!!}
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script type="text/javascript">
        function validateForm(){
            ...
            var validator = $("#update_thongtinngaynghile").validate({
                rules: {
                    ten :"required"
                },
                messages: {
