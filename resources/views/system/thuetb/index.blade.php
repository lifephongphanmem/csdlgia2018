...
@section('content')
    ...
    <h3 class="page-title">
        Thông tin<small>&nbsp;xe thuế trước bạ</small>
    </h3>
    <h4 style="color: #0000ff">Loại xe: {{$modelloai->tenloai}}</h4>
    <!-- END PAGE HEADER-->
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="portlet box ">
                <div class="portlet-title">
                    ...
                    <div class="actions">
                        <a href="{{url('dmloaixe-thuetruocba/maloai='.$modelloai->maloai.'/create')}}" class="btn btn-default btn-sm">
                ...
                <div class="portlet-body">
                    ...
                    <table class="table table-striped table-bordered table-hover" id="sample_3">
                        ...
                        <tr>
                            ...
                            <th style="text-align: center">Nước sx</th>
                        ...
                        <tr>
                            ...
                            <td class="success">{{$tt->tenhieu}}</td>
                            <td>{{$tt->thongsokt}}</td>
                            <td>{{$tt->dungtich}}</td>
                            <td>{{$tt->nuocsx}}</td>
                            <td style="text-align: right">{{number_format($tt->gia!=''? $tt->gia : 0)}}</td>
                            <td>{{$tt->ghichu}}</td>
                            <td>
                                <a href="{{url('dmloaixe-thuetruocba/'.$tt->id.'/edit')}}" class="btn btn-default btn-xs mbs">
    ...
    <div class="modal fade" id="delete-modal-confirm" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                {!! Form::open(['url'=>'dmloaixe-thuetruocba/delete','id' => 'frm_delete'])!!}
