...
<div class="content">
	<!-- BEGIN LOGIN FORM -->
	{!! Form::open(['url'=>'/dangkytaikhoantruycap/checkmadangky','id' => 'form-seachregister', 'class'=>'form-horizontal form-validate']) !!}
	<div class="form-body">
		<h4>Nhập thông tin mã số thuế và mã đăng ký để chỉnh sửa thông tin đăng ký tài khoản</h4>
		...
		<div class="row">
			<div class="col-md-12">
				<div class="form-group">
					<label class="control-label">Mã đăng ký</label>
					{!!Form::text('mahs', null, array('id' => 'mahs','class' => 'form-control required'))!!}
				</div>
			</div>
		</div>
