...
@section('content')
        ...
        <div class="col-md-12 center">
            ...
            <div class="portlet box blue">
                ...
                <div class="portlet-body form">
                    <!-- BEGIN FORM-->
                    {!! Form::open(['url'=>'district', 'id' => 'create_district', 'class'=>'horizontal-form']) !!}
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control required" name="mahuyen" id="mahuyen">
                                    </div>
                                </div>
                                <!--/span-->
                            </div>
    ...
    <script type="text/javascript">
        function validateForm(){
            ...
            var validator = $("#create_district").validate({
                rules: {
                    ten :"required"
                },
                messages: {
