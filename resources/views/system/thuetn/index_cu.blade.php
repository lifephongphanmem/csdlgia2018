...
@section('content')
    ...
    <h4 style="color: #0000ff">Nhóm tài nguyên: {{$tennhom}} - Phân nhóm tài nguyên: {{$tenpnhom}}</h4>
    <!-- END PAGE HEADER-->
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="portlet box">
                <div class="portlet-title">
                    ...
                    <div class="actions">
                        <a href="{{url('dmthuetn/nhom='.$nhom.'/pnhom='.$pnhom.'/create')}}" class="btn btn-default btn-sm">
                ...
                <div class="portlet-body">
                    ...
                    <table class="table table-striped table-bordered table-hover" id="sample_3">
                        ...
                        <tr>
                            ...
                            <th style="text-align: center" width="20%">Mã tài nguyên</th>
                        ...
                        @foreach($model as $key=>$tt)
                            <tr>
                                ...
                                <td>
                                    <a href="{{url('dmthuetn/'.$tt->id.'/edit')}}" class="btn btn-default btn-xs mbs"><i class="fa fa-eye"></i>&nbsp;Chi tiết</a>
