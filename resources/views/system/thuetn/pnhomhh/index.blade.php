...
@section('content')
    ...
    <h3 class="page-title">
        Danh mục tài nguyên<small> tính thuế tài nguyên</small>
    </h3>
    <!-- END PAGE HEADER-->
    <div class="row">
        <div class="col-md-12">
                ...
                <div class="portlet-body">
                    ...
                    <table class="table table-striped table-bordered table-hover" id="sample_3">
                        ...
                        <tr>
                            ...
                            <th style="text-align: center" width="20%">Mã phân nhóm tài nguyên</th>
                            <th style="text-align: center">Tên phân nhóm tài nguyên</th>
                        ...
                        @foreach($model as $key=>$tt)
                            <tr>
                                ...
                                <td style="text-align: center">{{$tt->mapnhom}}</td>
                                ...
                                <td>
                                    <a href="{{url('dmthuetn/nhom='.$tt->manhom.'/pnhom='.$tt->mapnhom)}}" class="btn btn-default btn-xs mbs"><i class="fa fa-eye"></i>&nbsp;Chi tiết</a>
                                </td>
                            </tr>
                        @endforeach
