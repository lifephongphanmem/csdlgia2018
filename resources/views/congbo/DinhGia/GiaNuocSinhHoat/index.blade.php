...
@section('custom-script-cb')
    ...
    <script>
        $(function(){
            $('#nam,#district,#doituong,#mota,#paginate').change(function() {
                ...
                var url = current_path_url+nam+doituong+mota+paginate;
                            ...
                            <div class="portlet light" style="min-height: 587px">
                                <div class="portlet-title">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject theme-font bold uppercase">Giá nước sạch sinh hoạt</span>
                                    </div>
                                    <div class="tools">
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            <label class="control-label" style="font-weight: bold">Đối tượng<span class="require">*</span></label>
