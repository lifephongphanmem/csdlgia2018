...
@section('content-cb')
            ...
            <div class=" col-sm-12">
                ...
                <div class="portlet light">
                    <div class="portlet-title">
                        ...
                        <div class="actions">
                            <a href="{{url('giavantaixekhach/'.$modeldn->maxa.'/history')}}" class="btn green"><i class="fa fa-eye"></i> Thông tin kê khai gần đây</a>
                        </div>
                    </div>
    ...
    <div style="text-align: center">
        <a href="{{url('giavantaixekhach')}}" class="btn btn-danger"><i class="fa fa-reply"></i>&nbsp;Quay lại</a>
    </div>
@stop 