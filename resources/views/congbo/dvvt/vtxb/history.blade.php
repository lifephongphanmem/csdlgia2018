...
@section('content-cb')
                ...
                <div class="portlet light">
                    <div class="portlet-title">
                        <div class="caption caption-md">
                            ...
                            <span class="caption-subject theme-font bold uppercase">Thông tin hồ sơ kê khai vận tải xe buýt</span>
                        </div>
                        <div class="actions">
                        </div>
                    </div>
    ...
    <div style="text-align: center">
        <a href="{{url('giavantaixebus/'.$modeldn->maxa)}}" class="btn btn-danger"><i class="fa fa-reply"></i>&nbsp;Quay lại</a>
    </div>
    <div class="clearfix">
    </div>
