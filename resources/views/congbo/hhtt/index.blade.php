    ...
    <script>
        ...
        $(function(){
            $('#nambc').change(function() {
                var nambc = $('#nambc').val();
                var ttpb = $('#ttpb').val();
                var thoidiem = '{{$inputs['thoidiem']}}';
                var url = '/hanghoathitruong/index?thoidiem='+thoidiem+'&nam='+nambc+'&pb='+ttpb;
                ...
                <div class="portlet light">
                    <div class="portlet-title">
                        <div class="caption caption-md">
                            ...
                            <span class="caption-subject theme-font bold uppercase">báo cáo giá hàng hóa thị trường</span>
                        ...
                        <table class="table table-striped table-bordered table-hover" id="sample_3">
                            ...
                            @foreach($model as $key=>$tt)
                                <tr>
                                    ...
                                    <td>{{$tt->thitruong}}</td>
                                    <td>
                                        <a href="{{url('hanghoathitruong/detail?mahs='.$tt->mahs)}}" class="btn btn-default btn-xs mbs"><i class="fa fa-eye"></i>&nbsp;Xem thông tin </a>
                                    </td>
                                </tr>
                            @endforeach
                            </tbody>
