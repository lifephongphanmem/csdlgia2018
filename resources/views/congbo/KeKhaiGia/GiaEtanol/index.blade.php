...
@section('custom-script-cb')
    ...
    <script>
        ...
        $(function(){
            $('#nam,#tendn,#tthhdv,#paginate').change(function() {
                var current_path_url = '/cbgiaetanol?';
                var nam = '&nam='+$('#nam').val();
                var tthhdv = '&tthhdv=' + $('#tthhdv').val();
                var tendn = '&tendn=' + $('#tendn').val();
                var paginate = '&paginate='+$('#paginate').val();
                var url = current_path_url+nam+tendn+tthhdv+paginate;
                            ...
                            <div class="portlet light" style="min-height: 587px">
                                <div class="portlet-title">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject theme-font bold uppercase">Giá Etanol nhiên liệu không biến tính, khí tự nhiên hóa lỏng(LNG); khí thiên nhiên nén (CNG)</span>
                                    </div>
                                    <div class="tools">
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="tthhdv" name="tenhh" value="{{$inputs['tthhdv']}}">
                                        </div>
                                    </div>
                                </div>
                                <br>
