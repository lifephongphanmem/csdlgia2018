            ...
            <!--div class="portlet light"-->
                <div class="portlet-title">
                    ...
                    <div class="caption caption-md">
                        ...
                        <span class="caption-subject theme-font bold uppercase">Etanol nhiên liệu không biến tính, khí tự nhiên hóa lỏng(LNG); khí thiên nhiên nén (CNG)</span>
                    </div>
                    </div>
                    <div class="row">
                        <div class="col-md-2">
