    ...
    <script>
        ...
        $(function(){
            $('#nambc').change(function() {
                var nambc = $('#nambc').val();
                var ttpb = $('#ttpb').val();
                var url = '/congbg?nam='+nambc+'&pb='+ttpb;
                ...
                <div class="portlet light">
                    <div class="portlet-title">
                        <div class="caption caption-md">
                            ...
                            <span class="caption-subject theme-font bold uppercase">thông tin hồ sơ công bố giá</span>
                        </div>
                        <div class="actions">
                        </div>
                    </div>
                        ...
                        <table class="table table-striped table-bordered table-hover" id="sample_3">
                            ...
                            @foreach($model as $key=>$tt)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{url('congbg/detail?mahs='.$tt->mahs)}}" class="btn btn-default btn-xs mbs"><i class="fa fa-eye"></i>&nbsp;Xem thông tin </a>
                                    </td>
                                </tr>
                            @endforeach
                            </tbody>
